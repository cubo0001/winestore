...
$interiart_sidebar_demo = '';
if(isset($_GET["sidebar"]) && !empty($_GET["sidebar"])){
    $interiart_sidebar_demo = $_GET["sidebar"];
}
...
<div class="row">
<?php
if($interiart_sidebar_demo == 'left' || $interiart_sidebar == 'left'){
    get_sidebar();
}
?>
<div class="col-md-9">
            ...
            <div id='post-<?php the_ID(); ?>' class="tzBlogItem">
                ...
                if($interiart_item_type == 'quote'){
                    ...
                    <div class="tzBlogQuote">
                        ...
                        <span class="icon_quotations tzBlogQuote_char" aria-hidden="true"></span>
                        <?php the_content();?>
...
<?php
if($interiart_sidebar_demo != 'left' && $interiart_sidebar == 'right'){
    get_sidebar('right');
}
?>
</div>
