...
var AdminEssentials = new function(){
	...
	t.initMetaBox = function(){
		...
		jQuery('#eg-add-custom-meta-field').on('click',function(){
			t.add_meta_element();
		});
	...
	t.initCustomMeta = function(){
		...
		jQuery('#eg-meta-add').on('click',function(){
		...
		jQuery('#eg-link-meta-add').on('click',function(){
		...
		jQuery('.eg-custom-meta-info-box').on('click',function() {
	...
	t.initWidgetAreas = function(){
		jQuery('#eg-widget-area-add').on('click',function(){
	...
	t.initGoogleFonts = function(){
		...
		jQuery('#eg-font-add').on('click',function(){
	...
	t.initSearchSettings = function(){
		...
		jQuery('#eg-btn-save-settings').on('click',function(){
			var data = {};
		...
		jQuery('input[name="search-enable"]').on('click',function(){
		...
		jQuery('#eg-btn-add-global-setting').on('click',function(){
			t.append_global_setting( {} );
			t.initAccordion();
		});

		jQuery('#eg-btn-add-shortcode-setting').on('click',function(){
		...
		jQuery('.eg-search-settings-info-box').on('click',function() {
			if (jQuery(this).hasClass("show")) {
		...
		jQuery('input[name="sc-shortcode[]"]').on('click',function(){
			this.select();
		});
	}
	...
	t.initAccordion = function(){
		...
		jQuery(".postbox-arrow").each(function(i) {
			...
			jQuery(this).closest('h3').on('click',function(){
	...
	***********************/
	...
	t.initCreateGrid = function(doAction){
		...
		jQuery("input[name='shortcode']").on('click',function(){
			this.select();
		});

		t.updateShortcode();

		jQuery('input[name="ajax-container-position"]').on('click',function(){
		...
		jQuery('#eg-btn-save-grid').on('click',function(){
		...
		jQuery('#eg-btn-delete-grid').on('click',function(){
		...
		jQuery('.filter-meta-selector').on('click',function(event){
		 ...
		 */
		jQuery('#eg-edit-navigation-skin').on('click',function(){
		 ...
		 */
		jQuery('#eg-delete-navigation-skin').on('click',function(){
		 ...
		 */
		jQuery('#eg-create-navigation-skin').on('click',function(){
		...
		**/
		...
		jQuery('.eg-api-inputs').on('click',function(){
			jQuery(this).select().focus();
		});

		jQuery('.eg-default-image-add').on('click',function(e) {
			e.preventDefault();
		...
		jQuery('.eg-default-image-clear').on('click',function(e) {
			e.preventDefault();
		 ...
		 *******************/
		jQuery('.eg-add-filter-box').on('click',function(){
			eg_filter_counter++;
		...
		jQuery('.eg-add-new-cobbles-pattern').on('click',function(){
	...
	t.initImportExport = function(){
		...
		jQuery('#esg-import-data').on('click',function(){
		...
		jQuery('#eg-grid-export-import-wrapper .eg-li-intern-wrap').on('click',function(ev){
		 ...
		 * Import Demo Posts
		 */
		jQuery('#esg-import-demo-posts').on('click',function(){
...
/*			jQuery('#eg-lb-twitter').show();
	...
	**/
	t.skinSelectorFakes = function() {
		jQuery('.eg-fakeinput, .esg-screenselect-toolbar').on('click',function() {
	...
	***********************/
	...
	t.initOverviewGrid = function(doAction){
		...
		jQuery('.eg-btn-duplicate-grid').on('click',function(){
		...
		jQuery("#ess-grid-delete-cache").on('click',function(){
			var data = {};

			t.ajaxRequest("delete_full_cache", data, '#ess-grid-delete-cache');
		});
		
		jQuery('.eg-toggle-favorite').on('click',function(){
	...
	***********************/
	...
	t.globalSettingsDialog = function(){
		jQuery("#button-general-settings").on('click',function(){
	...
	t.getPagesDialog = function(){
		...
		jQuery("#button-add-pages").on('click',function(){
		...
		jQuery('#check-uncheck-pages').on('click',function(){
			var do_enable = true;
	...
	***********************/
	...
	t.ajaxRequest = function(action,data,statusElement,successFunction,args){
		...
		jQuery.ajax({
			...
			success:function(response){
				...
				if(response == 0){
					t.showErrorMessage('ajax error! action not found: <b>'+action+'</b>');
					return(false);
				}
	...
	t.showAjaxLoader = function(){
		if(ajaxLoaderElement){
			...
			jQuery(ajaxLoaderElement).parent().append('<div class="ajax-loading-wrap">'+'Please wait...'+'</div>');
		}
	}
	...
	t.initSideButtons = function(i) {
		...
		jQuery('.eg-side-buttons').on('hover',function() {
	...
	********************************/
	...
	t.createPreviewGrid = function() {
		...
		jQuery('.esg-refresh-preview-button').on('click',function() {
			t.changePreviewGrid(true);
		})
...
******************************************************/
	...
	t.eg3dtakeCare = function() {
		...
		jQuery('#drop-1').on('click',function() {
			var bt = jQuery(this);
			var cl = ".dropzonetext";
	...
	********************************************/
	...
	t.initUpdateRoutine = function(){
		...
		jQuery('#eg-validation-activate').on('click',function(){
		...
		jQuery('#eg-validation-deactivate').on('click',function(){
	...
	t.initNewsletterRoutine = function(){
		...
		jQuery('#subscribe-to-newsletter').on('click',function(){
		...
		jQuery('#activate-unsubscribe').on('click',function(){
		...
		jQuery('#cancel-unsubscribe').on('click',function(){
		...
		jQuery('#unsubscribe-to-newsletter').on('click',function(){
