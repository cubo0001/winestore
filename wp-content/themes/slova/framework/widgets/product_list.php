<?php
class RO_Widget_Products extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( 'WooCommerce Products List', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
...
/* Class RO_Widget_Products */
function register_product_list_widget() {
    register_widget('RO_Widget_Products');
}
