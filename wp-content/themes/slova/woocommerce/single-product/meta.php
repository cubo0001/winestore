...
<div class="product_meta">
	...
	<?php //echo $product->get_categories( '', '<div class="posted_in">' . _n( '<h3>Category:</h3>', '<h3>Categories:</h3>', $cat_count, 'woocommerce' ) . ' ', '</div>' ); ?>

	<?php echo wc_get_product_tag_list ($product->get_id() , '', '<div class="tagged_as">' . _n( '<h3>Tags:</h3>', '<h3>Tags:</h3>', $tag_count, 'woocommerce' ) . ' ', '</div>' ); ?>
