...
} elseif('slickslider' === $type){
    $el_start = '<div class="slickslider-item">';
    $el_end = '</div>';
    $slides_wrap_start = '<div class="slickslider">';
    $slides_wrap_end = '</div>';
    wp_enqueue_style( 'slick' );
//    wp_enqueue_style( 'slick-theme' );
    wp_enqueue_script( 'slick.min' );
    wp_enqueue_script( 'tz-slick-slider' );
} elseif('owl_carousel' === $type){
	$el_start = '<div class="tzOwlCarouselSlider-item">';
	$el_end = '</div>';
	$slides_wrap_start = '<div class="tzOwlCarouselSlider">';
	$slides_wrap_end = '</div>';
	wp_enqueue_style( 'owl.carousel' );
	wp_enqueue_script( 'owl.carousel' );
	wp_enqueue_script( 'tz-owl-carousel-slider' );
