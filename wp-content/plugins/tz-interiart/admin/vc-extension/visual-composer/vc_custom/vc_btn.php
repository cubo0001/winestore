 ...
 * @var $tz_padding_top
 * @var $tz_font_family
 * @var $tz_padding_bottom
 * @var $tz_padding_left
 * @var $tz_padding_right
 * Shortcode class
...
if($tz_font_family != ''){
    $button_classes[] = 'tz-font-'.$tz_font_family;
}
...
?>
	<div class=" <?php echo trim( $wrapper_classes ); ?>" <?php
    if($tz_padding_top != '' || $tz_padding_bottom != '' || $tz_padding_right != '' || $tz_padding_left != ''){
        echo 'style="';
        if($tz_padding_top != ''){
        ...
        if($tz_padding_left != ''){
            echo 'padding-left:'.esc_attr($tz_padding_left).'px;';
        }

        if($tz_padding_right != ''){
            echo 'padding-right:'.esc_attr($tz_padding_right).'px;';
        }
        echo '"';
    }
    ?>><?php if ( $use_link ) {
...
} ?></div><?php echo balanceTags($this->endBlockComment( $this->getShortcode() ));
